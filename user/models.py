...
class User(models.Model):
    ...
    cart = models.ForeignKey('user.CartNumber', on_delete=models.SET_NULL, blank=True, null=True)
    address = models.ForeignKey('user.Address', on_delete=models.SET_NULL, blank=True, null=True)
